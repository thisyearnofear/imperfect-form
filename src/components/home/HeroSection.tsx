      ...
      <div className="relative z-10 p-4 md:p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-yellow-400 to-amber-600 flex items-center justify-center shadow-lg shadow-yellow-500/30">
              <span className="text-2xl font-black text-black">{progress.currentLevel}</span>
            </div>
            <div>
          ...
          {streakInfo && streakInfo.currentStreak > 0 && (
            <div className="flex items-center gap-2 bg-orange-500/20 px-3 py-1.5 rounded-full border border-orange-500/30">
              ...
              <div>
                <div className="text-orange-400 font-black text-sm">{streakInfo.currentStreak}</div>
        ...
        <div className="mb-4">
          ...
          <div className="h-2.5 bg-gray-800 rounded-full overflow-hidden shadow-inner">
            <div
              className="h-full bg-gradient-to-r from-yellow-500 to-amber-500 rounded-full transition-all duration-500 shadow-[0_0_10px_rgba(252,177,49,0.4)]"
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          ...
          <div className="bg-white/5 rounded-lg p-3 border border-white/5">
            ...
            <div className="text-2xl font-black text-green-400">{pbs.pushups || 0}</div>
          </div>
          ...
          <div className="bg-white/5 rounded-lg p-3 border border-white/5">
            ...
            <div className="text-2xl font-black text-blue-400">{pbs.squats || 0}</div>
          </div>
        </div>

        {/* Feature Preview - Next Unlock */}
        {nextUnlockLevel && (
          <div
        ...
        <button
          ...
          className="w-full py-4 bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-400 hover:to-amber-500 text-black font-black text-lg rounded-xl shadow-lg shadow-yellow-500/30 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
        >
