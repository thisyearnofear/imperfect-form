        ...
        <div id="screen">
          ...
          {started && (
            <>
              ...
              {/* Desktop HUD - outside canvasContainer */}
              {!isMobile && (
                <div className="absolute top-4 left-1/2 -translate-x-1/2 flex justify-center items-start gap-4 z-50 pointer-events-none">
