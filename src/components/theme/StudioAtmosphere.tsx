 ...
 * CSS 3D cursor-gaze (own stage — no third-party Spline scene) + multi-chain blooms.
 */
export function StudioAtmosphere() {
  ...
  return (
    <div ref={rootRef} className="studio-atmosphere" aria-hidden="true">
      <div className="studio-atmosphere__wash" />

      {/* Planned live networks — soft blooms, not a theme takeover */}
      <div className="studio-atmosphere__spectrum" aria-hidden="true">
      ...
      <div className="studio-atmosphere__network-row" aria-hidden="true">
