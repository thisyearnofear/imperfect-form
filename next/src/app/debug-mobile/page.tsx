...
export default function DebugMobilePage() {
  const { isMobile, isWalletBrowser, walletBrowserType, isClient } =
    useDeviceDetect();
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-900 p-4 rounded-lg mb-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span
                className={isWalletBrowser ? "text-green-400" : "text-red-400"}
              >
            ...
            <div className="flex justify-between">
              ...
              <span className="text-blue-400">
                {walletBrowserType || "None detected"}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 p-4 rounded-lg mb-6">
          ...
          <div className="space-y-3 text-xs">
            <div>
              ...
              <div className="bg-black p-2 rounded mt-1 break-all">
        ...
        <div className="bg-purple-900/30 border border-purple-500 p-4 rounded-lg">
          ...
          <div className="text-sm space-y-2">
            <p>
              1. <strong>Desktop Browser:</strong> Should show &quot;Is Mobile:
              NO&quot; and &quot;Is Wallet Browser: NO&quot;
            </p>
            <p>
              2. <strong>Mobile Browser:</strong> Should show &quot;Is Mobile:
              YES&quot;
            </p>
            <p>
              3. <strong>Wallet Browser:</strong> Should show both &quot;Is
              Mobile: YES&quot; and &quot;Is Wallet Browser: YES&quot;
            </p>
            <p>
              4. <strong>Wallet Type:</strong> Should detect specific wallet
