...
export async function POST(req: NextRequest) {
  try {
    ...
    const payload = {
      ...
      version: '1',
      aud: typeof window !== 'undefined' ? window.location.origin : 'https://imperfect-form.vercel.app',
    };
    ...
    return NextResponse.json({ error: 'Failed to generate authentication payload' }, { status: 500 });
  }
}
