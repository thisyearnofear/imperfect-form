...
const ThemeButton = forwardRef<HTMLButtonElement, ThemeButtonProps>(
  ({ 
    ...
    return (
      ...
      >
        {loading && (
          <span className="theme-button__spinner" />
        )}
        {icon && (
  ...
  ({
    ...
    return (
      <div className="theme-input-wrapper">
        {label && (
          <label className="theme-input__label">
            {label}
          </label>
        )}
        ...
        <div className="theme-input__container">
          {leftIcon && (
            <span className="theme-input__icon theme-input__icon--left">
              {leftIcon}
            </span>
          )}
          ...
          {rightIcon && (
            <span className="theme-input__icon theme-input__icon--right">
              {rightIcon}
            </span>
          )}
        </div>
        ...
        {error && (
          <span className="theme-input__error">
            {error}
          </span>
        )}
      </div>
...
const ThemeTooltip: React.FC<ThemeTooltipProps> = ({
  ...
  return (
    <div
      className="theme-tooltip-wrapper"
...
const ThemeProgress: React.FC<ThemeProgressProps> = ({
  ...
  return (
    <div className="theme-progress-wrapper">
      {showLabel && (
        <div className="theme-progress__label">
    ...
    >
      ...
      {!compact && (
        <div className="theme-preview__content">
          <div className="theme-preview__sample-button">
            Sample Button
          </div>
          <div className="theme-preview__sample-card">
            <div className="theme-preview__sample-text">
              Sample Text
            </div>
          </div>
        </div>
