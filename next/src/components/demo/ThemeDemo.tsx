      ...
      <div style={{ 
        ...
        <ThemeCard title="Buttons" hoverable>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
              <ThemeButton variant="primary" size="sm">Primary</ThemeButton>
              <ThemeButton variant="secondary" size="sm">Secondary</ThemeButton>
              <ThemeButton variant="accent" size="sm">Accent</ThemeButton>
            </div>
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
              <ThemeButton variant="ghost" size="sm">Ghost</ThemeButton>
              <ThemeButton variant="outline" size="sm">Outline</ThemeButton>
              <ThemeButton variant="primary" size="sm" loading>Loading</ThemeButton>
            </div>
            <ThemeButton variant="primary" fullWidth>Full Width Button</ThemeButton>
          </div>
        </ThemeCard>
        ...
        <ThemeCard title="Badges & Indicators" hoverable>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
              <ThemeBadge dot color="primary">Online</ThemeBadge>
              <ThemeBadge dot color="secondary">Pending</ThemeBadge>
        ...
        <ThemeCard title="Interactive Elements" hoverable>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
              <span style={{ color: currentTheme.palette.textSecondary }}>
                Theme Color:
              </span>
              <div style={{
                width: '2rem',
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <p style={{ color: currentTheme.palette.text }}>
            This modal demonstrates the theme-aware modal component with proper
            styling that adapts to the current chain theme.
          </p>
