...
export default function PoseDetectionGuidance({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className={`max-w-md w-full ${currentGuidance.bgColor} ${currentGuidance.borderColor} border rounded-lg p-6 text-center space-y-4`}>
        {/* Header */}
        <div className="space-y-2">
          <div className="text-4xl">{currentGuidance.icon}</div>
          <h2 className={`text-xl font-bold ${currentGuidance.color}`}>
