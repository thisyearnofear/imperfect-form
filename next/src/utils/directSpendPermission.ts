...
const SUBACCOUNT_FACTORY_ADDRESS =
  "0x000000006551c19487814612e58FE06813775758" as `0x${string}`;
...
const subAccountFactoryABI = [
  {
    ...
    outputs: [
      { internalType: "address[]", name: "subAccounts", type: "address[]" },
    ],
...
export async function getSmartAccount(
  ...
  try {
    ...
    if (provider?.isCoinbaseWallet) {
      ...
      console.log(
        "Coinbase Wallet detected, but couldn't find smart account through contract"
      );
    }
